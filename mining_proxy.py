...
def parse_args():
    ...
    parser.add_argument('-swp', '--switch-periodicity', dest='switch_periodicity', type=int, default=15, help='Override default switch periodicity.')
